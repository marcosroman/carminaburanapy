const letras = [
{
	...
	comentarios: "En esta música, posiblemente la más reconocida de la obra, Orff utiliza un acompañamiento orquestal que se repite sin cesar para sugerir el giro implacable de la rueda de (la) Fortuna.",
	letra: [
		[`O Fortuna,
		velut luna
		statu variabilis,`
...
,
{
	...
	letra: [
		...
		Flora principatur,
		nemorum dulcisono
		que cantu celebrantur`
		,
		`Flora reina, 
		vestida en varios ornamentos,
		El dulce sonido de los bosques
		la alaban cantando`
		]
		,
		[`Flore fusus gremio
		...
		risum dat hoc vario
		iam stipate flore`,
		`Recostada en el regazo de Flora
		Febus sonrie una vez más,
		cubierto por coloridas flores.`]
		,
		[`Zephyrus nectareo
		spirans in odore
		Certatim pro bravio
		curramus in amore`,
		`Céfiro sopla
		brisas con aroma a néctar.
		Apresurémonos para competir
		...
		,
		`En tonos de arpa
		canta dulce Filomena,
		Llenos de flores coloridas
		los serenos prados sonrien`
		],
		[`salit cetus avium
		silve per amena,
		...
		través de los placenteros bosques.
		Un coro de doncellas
		promete ya mil alegrías.`]
	]
}
,
{
...
},
{
	...
	letra: [
		...
		y mi congregación es de bebedores,
		y mi deseo es estar en el orden de los apostadores,
		y el que me busca por la mañana en la taberna
		partirá desnudo por la tarde,
		y así despojado de sus ropas, gritará:
		¡Wafna, wafna!
		¿Qué has hecho, vilísima fortuna?
		¡Has arrancado
		Todas las alegrías de mi vida!`]
	]
},
{
	bg: '#1a21e5',
	...
	letra: [ 
		...
		luego beben por los prisioneros,
		y despues por los vivos,
		cuarto, beben por todos los cristianos,
		quinto, beben por los fieles difuntos,
		sexto, beben por las hermanas descarriadas,
		séptimo, beben por los soldados en el bosque,`],
